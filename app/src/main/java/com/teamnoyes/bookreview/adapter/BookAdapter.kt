...
import com.teamnoyes.bookreview.databinding.ItemBookBinding
import com.teamnoyes.bookreview.model.Book

class BookAdapter(private val itemClickedListener: (Book) -> Unit): ListAdapter<Book, BookAdapter.BookItemViewHolder>(diffUtil) {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BookAdapter.BookItemViewHolder {
